...
def generateImage():
    ...
    img4 = Image.new('RGB', (64, 64), color='black')
    draw = ImageDraw.Draw(img4)

    img5 = Image.new('RGB', (64, 64), color='black')
    draw = ImageDraw.Draw(img5)

    img6 = Image.new('RGB', (64, 64), color='black')
    ...
    img5.paste(img2, (0,0))
    img5.paste(img1, (img2.size[0],0))
    
    #Zweites Mergen

    WIDTH=img3.size[0] + img4.size[0]
    HEIGHT=img3.size[1]
    
    img6.paste(img4, (0,0))
    img6.paste(img3, (img4.size[0],0))
